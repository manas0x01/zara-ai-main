  ...
  return (
    <section className="interactive-demo scroll-reveal" id="demo">
      <div className="container">
        <h2 className="section-title">Try Myra AI Now</h2>
          ...
          <div className="chat-interface" id="chatInterface">
            <div className="chat-message ai-message">
              <div className="message-bubble">
                👋 Hello! I'm Myra AI, your intelligent companion. I can help with conversations, analyze images, assist with creative projects, answer questions, and much more. What would you like to explore together?
              </div>
            </div>
          </div>
